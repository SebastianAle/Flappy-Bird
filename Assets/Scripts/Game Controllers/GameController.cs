...
public class GameController : MonoBehaviour 
{
	...
	{
		MakeSingleton ();
		IsTheGameStartedFromTheFirstTime ();
	}
	...
	void IsTheGameStartedFromTheFirstTime()
	{
		if (!PlayerPrefs.HasKey ("IsTheGameStartedFromTheFirstTime")) 
		{
			PlayerPrefs.SetInt (HIGH_SCORE, 0);
			PlayerPrefs.SetInt (SELECTED_BIRD, 0);
			PlayerPrefs.SetInt (GREEN_BIRD, 0);
			PlayerPrefs.SetInt (RED_BIRD, 0);
			PlayerPrefs.SetInt ("IsTheGameStartedFromTheFirstTime", 0);
		}
	}
